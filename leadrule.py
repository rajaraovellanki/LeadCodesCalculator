...
class LeadRule:
    ...
    def __init__(self, quantity, increment, incrementType):
        if isinstance(quantity, int) and isinstance(increment, int) and (incrementType == constants.INCREMENT_TYPE_FIXED or incrementType == constants.INCREMENT_TYPE_VARIABLE):
            ...
            self.logging.warning(
                self.moduleName+'Incorrect argument types. Please check if quantity is  \'int\', increment is \'int\' and increment type is \'fixed\', or \'variable\'')
            raise Exception(
                "Incorrect argument types. Please check if quantity is  \'int\', increment is \'int\' and increment type is \'fixed\', or \'variable\'")
    ...
    def setIncrementType(self, incrementType):
        if incrementType == constants.INCREMENT_TYPE_FIXED or incrementType == constants.INCREMENT_TYPE_VARIABLE:
            ...
            self.logging.warning(
                self.moduleName+'Increment type should be either \'fixed\', or \'variable\'')
            raise Exception(
                "Increment type should be either \'fixed\', or \'variable\'")
    ...
    def setIncrement(self, increment):
        if isinstance(increment, int):
            ...
            self.logging.warning(
                self.moduleName+'Increment should be of type: \'int\'')
